...
<body class="bg-slate-50">
    ...
    <main class="p-4 max-w-md mx-auto">
        ...
        <section class="grid grid-cols-2 gap-3 mb-4">
            <a href="https://kalemtayeb.com/adhkar/section/1" target="_blank" class="bg-amber-100 text-amber-800 p-3 rounded-xl flex items-center justify-center gap-2 font-bold hover:bg-amber-200 transition shadow-sm">
                <i class="fa-solid fa-sun text-xl text-amber-600"></i> أذكار الصباح
            </a>
            <a href="https://kalemtayeb.com/adhkar/section/2" target="_blank" class="bg-indigo-100 text-indigo-800 p-3 rounded-xl flex items-center justify-center gap-2 font-bold hover:bg-indigo-200 transition shadow-sm">
                <i class="fa-solid fa-moon text-xl text-indigo-600"></i> أذكار المساء
            </a>
        </section>
